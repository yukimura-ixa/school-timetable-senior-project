...
async function main() {
  ...
  const additionalSubjects = [
    ...
    { code: 'FR401', name: 'ภาษาฝรั่งเศส 1', credit: 'CREDIT_15' as subject_credit, learningArea: 'FOREIGN_LANGUAGE' as LearningArea },
    { code: 'FR501', name: 'ภาษาฝรั่งเศส 2', credit: 'CREDIT_15' as subject_credit, learningArea: 'FOREIGN_LANGUAGE' as LearningArea },
  ...
  console.log(`✅ Created ${coreSubjects.length + additionalSubjects.length + activitySubjects.length} subjects`);
  ...
  programs.push(await prisma.program.create({
    data: {
      ...
      Track: 'LANGUAGE_MATH',
      MinTotalCredits: 43,
      Description: 'หลักสูตรเน้นภาษาและคณิตศาสตร์สำหรับนักเรียนชั้นมัธยมศึกษาปีที่ 1',
    }
  }));
  ...
  programs.push(await prisma.program.create({
    data: {
      ...
      Track: 'LANGUAGE_ARTS',
      MinTotalCredits: 43,
      Description: 'หลักสูตรเน้นภาษาและศิลปะสำหรับนักเรียนชั้นมัธยมศึกษาปีที่ 1',
    }
  }));
  ...
  const m1SciSubjects = [
    ...
    { code: 'TH101', category: 'CORE' as SubjectCategory, minCredits: 1.5, mandatory: true },
    { code: 'MA101', category: 'CORE' as SubjectCategory, minCredits: 1.5, mandatory: true },
    { code: 'SC101', category: 'CORE' as SubjectCategory, minCredits: 1.5, mandatory: true },
    { code: 'SO101', category: 'CORE' as SubjectCategory, minCredits: 1.0, mandatory: true },
    { code: 'PE101', category: 'CORE' as SubjectCategory, minCredits: 1.0, mandatory: true },
    { code: 'AR101', category: 'CORE' as SubjectCategory, minCredits: 1.0, mandatory: true },
    { code: 'CA101', category: 'CORE' as SubjectCategory, minCredits: 1.0, mandatory: true },
    { code: 'EN101', category: 'CORE' as SubjectCategory, minCredits: 1.0, mandatory: true },
    
    // Additional subjects (track-specific)
    { code: 'MA102', category: 'ADDITIONAL' as SubjectCategory, minCredits: 1.0, mandatory: true },
    { code: 'SC102', category: 'ADDITIONAL' as SubjectCategory, minCredits: 1.0, mandatory: true },
    
    // Activities
    { code: 'ACT-CLUB', category: 'ACTIVITY' as SubjectCategory, minCredits: 1.0, mandatory: true },
    { code: 'ACT-SCOUT-M1', category: 'ACTIVITY' as SubjectCategory, minCredits: 1.0, mandatory: true },
    { code: 'ACT-GUIDE', category: 'ACTIVITY' as SubjectCategory, minCredits: 1.0, mandatory: true },
    { code: 'ACT-SERVICE', category: 'ACTIVITY' as SubjectCategory, minCredits: 0.5, mandatory: true },
  ];
  ...
  const teachers = [
    { prefix: 'นาย', firstname: 'สมชาย', lastname: 'วิชาการ', dept: 'คณิตศาสตร์', email: 'somchai@school.local' },
    { prefix: 'นางสาว', firstname: 'สุดารัตน์', lastname: 'วิทยา', dept: 'วิทยาศาสตร์', email: 'sudarat@school.local' },
    { prefix: 'นาง', firstname: 'วรรณา', lastname: 'ภาษา', dept: 'ภาษาไทย', email: 'wanna@school.local' },
    { prefix: 'นาย', firstname: 'ประวิทย์', lastname: 'อังกฤษ', dept: 'ภาษาอังกฤษ', email: 'prawit@school.local' },
    { prefix: 'นางสาว', firstname: 'นิภา', lastname: 'สังคม', dept: 'สังคมศึกษา', email: 'nipa@school.local' },
  ];
  ...
  console.log('');
  console.log('📊 Summary:');
  console.log(`   - ${programs.length} programs (วิทย์-คณิต, ศิลป์-คำนวณ, ศิลป์-ภาษา)`);
  console.log(`   - ${gradeLevels.length} grade levels (M.1-M.6, 3 sections each)`);
