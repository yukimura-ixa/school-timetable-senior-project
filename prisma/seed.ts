...
async function seedDemoData() {
  ...
  const ALL_SUBJECTS: Array<{
    ...
    { code: "ส21102", name: "ประวัติศาสตร์ ม.1", credit: "CREDIT_05", learningArea: "SOCIAL", category: "CORE" },
    { code: "ส21103", name: "หน้าที่พลเมือง ม.1", credit: "CREDIT_05", learningArea: "SOCIAL", category: "CORE" },
    ...
    { code: "ส22102", name: "ประวัติศาสตร์ ม.2", credit: "CREDIT_05", learningArea: "SOCIAL", category: "CORE" },
    { code: "ส22103", name: "หน้าที่พลเมือง ม.2", credit: "CREDIT_05", learningArea: "SOCIAL", category: "CORE" },
    ...
    { code: "ส23102", name: "ประวัติศาสตร์ ม.3", credit: "CREDIT_05", learningArea: "SOCIAL", category: "CORE" },
    { code: "ส23103", name: "หน้าที่พลเมือง ม.3", credit: "CREDIT_05", learningArea: "SOCIAL", category: "CORE" },
    ...
    { code: "ศ31101", name: "ศิลปะ ม.4", credit: "CREDIT_05", learningArea: "ARTS", category: "CORE" },
    { code: "ง31101", name: "การงานอาชีพ ม.4", credit: "CREDIT_05", learningArea: "CAREER", category: "CORE" },
    ...
    { code: "ศ32101", name: "ศิลปะ ม.5", credit: "CREDIT_05", learningArea: "ARTS", category: "CORE" },
    { code: "ง32101", name: "การงานอาชีพ ม.5", credit: "CREDIT_05", learningArea: "CAREER", category: "CORE" },
    ...
    { code: "ศ33101", name: "ศิลปะ ม.6", credit: "CREDIT_05", learningArea: "ARTS", category: "CORE" },
    { code: "ง33101", name: "การงานอาชีพ ม.6", credit: "CREDIT_05", learningArea: "CAREER", category: "CORE" },
    ...
    { code: "ว32203", name: "ฟิสิกส์ 3", credit: "CREDIT_15", learningArea: "SCIENCE", category: "ADDITIONAL" },
    { code: "ว32223", name: "เคมี 3", credit: "CREDIT_10", learningArea: "SCIENCE", category: "ADDITIONAL" },
    { code: "ว32243", name: "ชีววิทยา 3", credit: "CREDIT_15", learningArea: "SCIENCE", category: "ADDITIONAL" },
    { code: "อ32201", name: "ภาษาอังกฤษเพิ่มเติม 3", credit: "CREDIT_10", learningArea: "FOREIGN_LANGUAGE", category: "ADDITIONAL" },
    { code: "ว30294", name: "หุ่นยนต์ 1", credit: "CREDIT_05", learningArea: "SCIENCE", category: "ADDITIONAL" },
    // ม.6 วิทย์-คณิต (6/1) เพิ่มเติม — §8.3. Codeless โครงงาน1 skipped.
    { code: "ค33201", name: "คณิตศาสตร์เพิ่มเติม ม.6", credit: "CREDIT_15", learningArea: "MATHEMATICS", category: "ADDITIONAL" },
    { code: "ว33205", name: "ฟิสิกส์ 5", credit: "CREDIT_15", learningArea: "SCIENCE", category: "ADDITIONAL" },
    { code: "ว33225", name: "เคมี 5", credit: "CREDIT_15", learningArea: "SCIENCE", category: "ADDITIONAL" },
    { code: "ว33245", name: "ชีววิทยา 5", credit: "CREDIT_15", learningArea: "SCIENCE", category: "ADDITIONAL" },
    { code: "อ33201", name: "ภาษาอังกฤษเพิ่มเติม 5", credit: "CREDIT_10", learningArea: "FOREIGN_LANGUAGE", category: "ADDITIONAL" },
    { code: "ว30297", name: "วิทยาศาสตร์เลือก ม.6", credit: "CREDIT_10", learningArea: "SCIENCE", category: "ADDITIONAL" },
  ...
  const PROGRAM_SUBJECTS: Record<string, string[]> = {
    ...
    "M5-SCI":       ["ท32101","ค32101","ว32101","ส32101","พ32101","อ32101","ค32201","ว32203","ว32223","ว32243","อ32201","ว30294","ACT-GUIDE","ACT-CLUB","ACT-SCOUT-M5"],
    "M6-SCI":       ["ท33101","ค33101","ว33101","ส33101","พ33101","อ33101","ค33201","ว33205","ว33225","ว33245","อ33201","ว30297","ACT-GUIDE","ACT-CLUB","ACT-SCOUT-M6"],
...
async function main() {
  ...
  const coreSubjects = [
    ...
    {
      code: "ส21102",
      name: "ประวัติศาสตร์ 1",
      credit: "CREDIT_05" as subject_credit,
      learningArea: "SOCIAL" as LearningArea,
    },
    {
      code: "ส21103",
      name: "หน้าที่พลเมือง 1",
      credit: "CREDIT_05" as subject_credit,
      learningArea: "SOCIAL" as LearningArea,
    },
    {
    ...
    {
      code: "ส22102",
      name: "ประวัติศาสตร์ 2",
      credit: "CREDIT_05" as subject_credit,
      learningArea: "SOCIAL" as LearningArea,
    },
    {
      code: "ส22103",
      name: "หน้าที่พลเมือง 2",
      credit: "CREDIT_05" as subject_credit,
      learningArea: "SOCIAL" as LearningArea,
    },
    {
    ...
    {
      code: "ส23102",
      name: "ประวัติศาสตร์ 3",
      credit: "CREDIT_05" as subject_credit,
      learningArea: "SOCIAL" as LearningArea,
    },
    {
      code: "ส23103",
      name: "หน้าที่พลเมือง 3",
      credit: "CREDIT_05" as subject_credit,
      learningArea: "SOCIAL" as LearningArea,
    },
    {
