...
test.describe('Visual Inspection - Admin User Journey', () => {
  ...
  test('04. Management - Teachers', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/screenshots/admin-teacher-management.png', fullPage: true });
    await page.waitForTimeout(3000);
  });
  ...
  test('05. Management - Subjects', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/screenshots/admin-subject-management.png', fullPage: true });
    await page.waitForTimeout(3000);
  });
  ...
  test('06. Schedule Configuration', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/screenshots/admin-schedule-config.png', fullPage: true });
    await page.waitForTimeout(3000);
  });
  ...
  test('07. Teacher Arrangement Interface', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/screenshots/admin-teacher-arrange.png', fullPage: true });
  ...
  test('08. Analytics Dashboard', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/screenshots/admin-analytics.png', fullPage: true });
    await page.waitForTimeout(3000);
  });
});
...
test.describe('Visual Inspection - Component Test IDs', () => {
  test('Verify presence of key test IDs', async ({ page }) => {
    ...
    const testIds = ['teacher-selector', 'subject-list', 'timeslot-grid', 'save-button'];
