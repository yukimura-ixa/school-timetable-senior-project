...
test.describe("Visual Smoke Tests - Critical Pages", () => {
  ...
  test("Management - Teachers page visual check", async ({ page }) => {
    ...
    await expect(page.locator('main, [role="main"]')).toHaveScreenshot(
      "teachers-management.png",
      {
        animations: "disabled",
      },
    );
