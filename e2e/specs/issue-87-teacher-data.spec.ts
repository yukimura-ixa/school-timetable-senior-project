...
test.describe("Issue #87 - Teacher Data in Program View", () => {
  ...
  test("should display teacher names in program table", async ({
    programViewPage,
  }) => {
  ...
  test("should display teacher names in correct Thai format", async ({
    programViewPage,
  }) => {
    // Select a grade level
  ...
  test("should maintain teacher data across grade changes", async ({
    programViewPage,
  }) => {
    // Select first grade
    await programViewPage.selectGrade("ม.1");
  ...
  test("should show export button when teacher data is loaded", async ({
    programViewPage,
  }) => {
    // Select a grade level
    await programViewPage.selectGrade("ม.1");
  ...
  test("should display subject count with teacher assignments", async ({
    programViewPage,
  }) => {
    // Select a grade level
    await programViewPage.selectGrade("ม.1");
