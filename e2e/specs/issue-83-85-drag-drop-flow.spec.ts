...
test.describe('Issues #83-85 - Drag-Drop Room Selection Flow', () => {
  ...
  test('Issue #83 - should show room dialog after valid drag', async ({ arrangePage }) => {
  ...
  test('Issue #83 - should place subject after room selection', async ({ arrangePage }) => {
  ...
  test('Issue #84 - should validate subject placement', async ({ arrangePage }) => {
  ...
  test('Issue #85 - should respect locked timeslots', async ({ arrangePage }) => {
  ...
  test('should update subject palette after placement', async ({ arrangePage }) => {
    // Check if subject exists
    const hasSubject = await arrangePage.isSubjectInPalette('TH101');
