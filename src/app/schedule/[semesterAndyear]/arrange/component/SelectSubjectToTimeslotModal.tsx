      ...
      >
        <div className="flex flex-col w-[580px] h-fit p-7 gap-10 bg-white rounded">
          ...
          <div className="flex w-full h-auto justify-between items-center">
            <p className="text-lg select-none" onClick={() => console.log(RoomID)}>จัดวิชาเรียนลงในคาบ (2/8/24) ยังไม่ validate</p>
            <AiOutlineClose
          ...
          <div className="flex w-full items-end justify-end gap-4">
            <button onClick={() => {props.AddSubjectToSlot({...subjectSelected, RoomID: RoomID}, props.timeSlotID), props.setIsDragState()}} className="w-[100px] h-[45px] rounded bg-blue-100 text-blue-500">
              บันทึก
            </button>
            <button onClick={() => {props.CloseModal(), props.setIsDragState()}} className="w-[100px] h-[45px] rounded bg-red-100 text-red-500">
              ยกเลิก
            </button>
          </div>
        </div>
