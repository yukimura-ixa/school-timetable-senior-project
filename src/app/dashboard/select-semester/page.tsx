  ...
  return (
    <div className="flex flex-col gap-6 w-full">
      ...
      <div className="flex justify-end items-center">
        <PrimaryButton handleClick={() => {router.replace(`/dashboard/${semester}-${year}/student-table`)}} title={"ยืนยัน"} color={"primary"} Icon={undefined} reverseIcon={false} isDisabled={false} />
      </div>
    </div>
  );
};
