...
const AllTimeslotClient = ({
  ...
  const exportDisabledTooltip =
    "การส่งออกสงวนไว้สำหรับผู้ดูแลระบบเท่านั้น";
    ...
    <Container maxWidth="xl" sx={{ py: 4 }}>
      <Stack spacing={3}>
        ...
        >
          ...
          หน้านี้แสดงตารางสอนรวมเพื่อใช้ตรวจสอบและส่งออกเท่านั้น การแก้ไขคาบเรียน
          เวลา หรือครูผู้สอนต้องทำในหน้าจัดตาราง
          {isAdmin ? (
            <Box sx={{ mt: 1 }}>
              <Button
                size="small"
