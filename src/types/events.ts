 ...
 */
export type DetailedChangeHandler<T> = (
  value: T,
 ...
 */
export type AsyncFormSubmitHandler = (
 ...
 */
export type TypedFormSubmitHandler<T> = (
  data: T,
  event: FormEvent<HTMLFormElement>,
) => void;
 ...
 */
export type FocusBlurHandler<T extends HTMLElement = HTMLElement> = (
  event: FocusEvent<T>,
) => void;
