...
export type UnassignTeacherOutput = v.InferOutput<
  typeof unassignTeacherSchema
>;
...
export type CopyAssignmentsOutput = v.InferOutput<
  typeof copyAssignmentsSchema
>;
...
export type ClearAssignmentsInput = v.InferInput<
