...
export const ConfigIdSchema = v.pipe(
  ...
  v.regex(
    /^\d-\d{4}$/,
    'ConfigId must be in format "SEMESTER-YEAR" (e.g., "1-2567")',
  ),
);
...
export const GradeIdSchema = v.pipe(
  ...
  v.regex(
    /^\d{4}-\d+$/,
    'Grade ID must be in format "YEAR-NUMBER" (e.g., "2567-10")',
  ),
);
...
export type GetOverviewStatsInput = v.InferOutput<
  typeof GetOverviewStatsSchema
>;
export type GetGradeStatsInput = v.InferOutput<typeof GetGradeStatsSchema>;
export type GetTeacherWorkloadsInput = v.InferOutput<
  typeof GetTeacherWorkloadsSchema
>;
export type GetTeacherWorkloadByIdInput = v.InferOutput<
  typeof GetTeacherWorkloadByIdSchema
>;
export type GetTeachersByWorkloadStatusInput = v.InferOutput<
  typeof GetTeachersByWorkloadStatusSchema
>;
export type GetTopTeachersByHoursInput = v.InferOutput<
  typeof GetTopTeachersByHoursSchema
>;
export type GetRoomOccupancyInput = v.InferOutput<
  typeof GetRoomOccupancySchema
>;
export type GetRoomOccupancyByIdInput = v.InferOutput<
  typeof GetRoomOccupancyByIdSchema
>;
export type GetRoomsByUtilizationStatusInput = v.InferOutput<
  typeof GetRoomsByUtilizationStatusSchema
>;
export type GetTopRoomsByOccupancyInput = v.InferOutput<
  typeof GetTopRoomsByOccupancySchema
>;
export type GetSubjectDistributionInput = v.InferOutput<
  typeof GetSubjectDistributionSchema
>;
export type GetSubjectDistributionByCategoryInput = v.InferOutput<
  typeof GetSubjectDistributionByCategorySchema
>;
export type GetQualityMetricsInput = v.InferOutput<
  typeof GetQualityMetricsSchema
>;
export type GetPeriodDistributionInput = v.InferOutput<
  typeof GetPeriodDistributionSchema
>;
export type GetDayDistributionInput = v.InferOutput<
  typeof GetDayDistributionSchema
>;
export type GetPeakHoursInput = v.InferOutput<typeof GetPeakHoursSchema>;
export type GetProgramComplianceInput = v.InferOutput<
  typeof GetProgramComplianceSchema
>;
export type GetProgramComplianceByIdInput = v.InferOutput<
  typeof GetProgramComplianceByIdSchema
>;
export type GetProgramsBelowThresholdInput = v.InferOutput<
  typeof GetProgramsBelowThresholdSchema
>;
