...
export const createProgramSchema = v.object({
  ProgramCode: v.pipe(
    ...
    v.regex(
      /^M[1-6]-[A-Z-]+$/,
      "รหัสหลักสูตรต้องมีรูปแบบ M1-SCI, M2-LANG เป็นต้น",
    ),
  ),
  ProgramName: v.pipe(
...
export type GetProgramByGradeInput = v.InferOutput<
  typeof getProgramByGradeSchema
>;
...
export type GetProgramsByYearInput = v.InferOutput<
  typeof getProgramsByYearSchema
>;
...
export type AssignSubjectsToProgramInput = v.InferOutput<
